# RailsAdmin config file. Generated on June 08, 2013 00:58
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Livienyin Com', 'Admin']
  ...
  #     configure :template_name, :string 
  #     configure :background_color, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :order_index, :integer 
